...
const ContactInfo = (props:{contact: Contact, onEdit: (id: number) => void,  onShow:() => void, onDelete: (id: number) => void} ) => {
       return(
        ...
        <div className="contact-detail">
            ...
            <div className="contact-info-container">
                ...
                <div className="contact-actions">
                    ...
                    <button className="action-btn edit-btn" onClick={() => props.onEdit(props.contact.id)}>
